...
import net.aot.mytitan.entity.renderer.GluttonousTitanRenderer;
...
public class GluttonousTitanEntity extends MyTitanModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.5f, 4.5f)).build("gluttonous_titan").setRegistryName("gluttonous_titan");
	public GluttonousTitanEntity(MyTitanModElements instance) {
		super(instance, 217);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GluttonousTitanRenderer.ModelRegisterHandler());
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 45, 1, 2));
	}
