...
import net.aot.mytitan.entity.renderer.EntityErenHumanRenderer;
...
public class EntityErenHumanEntity extends MyTitanModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("entity_eren_human").setRegistryName("entity_eren_human");
	public EntityErenHumanEntity(MyTitanModElements instance) {
		super(instance, 222);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EntityErenHumanRenderer.ModelRegisterHandler());
