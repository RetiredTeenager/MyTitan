...
@OnlyIn(Dist.CLIENT)
public class EntityControllableCartTitanRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EntityControllableCartTitanEntity.entity, renderManager -> {
