...
@OnlyIn(Dist.CLIENT)
public class EntityControllableWarhammerTitanRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EntityControllableWarhammerTitanEntity.entity, renderManager -> {
