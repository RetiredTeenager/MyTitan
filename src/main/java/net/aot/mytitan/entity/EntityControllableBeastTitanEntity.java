...
import net.aot.mytitan.entity.renderer.EntityControllableBeastTitanRenderer;
...
public class EntityControllableBeastTitanEntity extends MyTitanModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(3f, 16f)).build("entity_controllable_beast_titan").setRegistryName("entity_controllable_beast_titan");
	public EntityControllableBeastTitanEntity(MyTitanModElements instance) {
		super(instance, 21);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EntityControllableBeastTitanRenderer.ModelRegisterHandler());
