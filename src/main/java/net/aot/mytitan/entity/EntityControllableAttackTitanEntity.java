...
import net.aot.mytitan.entity.renderer.EntityControllableAttackTitanRenderer;
...
public class EntityControllableAttackTitanEntity extends MyTitanModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(5f, 15f)).build("entity_controllable_attack_titan").setRegistryName("entity_controllable_attack_titan");
	public EntityControllableAttackTitanEntity(MyTitanModElements instance) {
		super(instance, 23);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EntityControllableAttackTitanRenderer.ModelRegisterHandler());
