...
import net.aot.mytitan.entity.renderer.EntityControllableColossalTitanRenderer;
...
public class EntityControllableColossalTitanEntity extends MyTitanModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(15f, 85f)).build("entity_controllable_colossal_titan").setRegistryName("entity_controllable_colossal_titan");
	public EntityControllableColossalTitanEntity(MyTitanModElements instance) {
		super(instance, 25);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EntityControllableColossalTitanRenderer.ModelRegisterHandler());
