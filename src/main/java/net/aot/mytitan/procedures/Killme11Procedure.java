...
public class Killme11Procedure extends MyTitanModElements.ModElement {
	public Killme11Procedure(MyTitanModElements instance) {
		super(instance, 140);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MyTitanMod.LOGGER.warn("Failed to load dependency entity for procedure Killme11!");
			return false;
		}
