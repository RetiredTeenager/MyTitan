...
public class Fade19Procedure extends MyTitanModElements.ModElement {
	public Fade19Procedure(MyTitanModElements instance) {
		super(instance, 200);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MyTitanMod.LOGGER.warn("Failed to load dependency entity for procedure Fade19!");
			return false;
		}
