...
public class Killme20Procedure extends MyTitanModElements.ModElement {
	public Killme20Procedure(MyTitanModElements instance) {
		super(instance, 149);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MyTitanMod.LOGGER.warn("Failed to load dependency entity for procedure Killme20!");
			return false;
		}
