...
public class ParticleWireParticle extends MyTitanModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ParticleWireParticle(MyTitanModElements instance) {
		super(instance, 219);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_wire"));
	}
